...
estimated_cost=250∗age−128∗sex+370∗bmi+425∗num_of_children+24000∗smoker−12500estimated\_cost = 250*age - 128*sex + 370*bmi + 425*num\_of\_children + 24000*smoker - 12500estimated_cost=250∗age−128∗sex+370∗bmi+425∗num_of_children+24000∗smoker−12500
...
class Patient:
  ...
  def estimated_insurance_cost(self):
      ...
      print(self.name + " estimated insurance costs is " +str(estimated_cost) + " dollars.")
  ...
  def update_bmi(self, new_bmi):
    self.bmi = new_bmi
    print(self.name + "'s BMI has been updated to " + str(self.bmi))
    self.estimated_insurance_cost()

  def update_smoking_status(self, new_smoker):
    self.smoker = new_smoker
    print(self.name + "'s smoking status has been updated.")
    self.estimated_insurance_cost()
